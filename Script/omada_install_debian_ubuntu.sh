...
#supported       :Ubuntu 20.04, Ubuntu 22.04, Debian 10, Debian 11
#author          :monsn0
...
if [[ $OS = *"Ubuntu 20.04"* ]]; then
    ...
    echo -e "\e[1;31m[!] Script currently only supports Ubuntu 20.04, Ubuntu 22.04, Debian 10, or Debian 11! \e[0m"
    exit
fi
...
echo "deb [ arch=amd64,arm64 signed-by=/usr/share/keyrings/mongodb-server-7.0.gpg ] https://repo.mongodb.org/apt/debian $OsVer/mongodb-org/7.0 main" > /etc/apt/sources.list.d/mongodb-org-7.0.list
apt-get -qq update
